...
dir.create(paste0("C:/Users/smunoz8/Google Drive/Post-doc/Niche Spaces/2019_03_31_GIS_Time_corrected analysis/datasets/Results_Pre_Post/Landuse/Pre"))
setwd(paste0("C:/Users/smunoz8/Google Drive/Post-doc/Niche Spaces/2019_03_31_GIS_Time_corrected analysis/datasets/Results_Pre_Post/Landuse/Pre"))
...
for (k in 1:length(Landuses)){
  dir.create(paste0("C:/Users/smunoz8/Google Drive/Post-doc/Niche Spaces/2019_03_31_GIS_Time_corrected analysis/datasets/Results_Pre_Post/Landuse/Pre/",Landuses[k]))
  setwd(paste0("C:/Users/smunoz8/Google Drive/Post-doc/Niche Spaces/2019_03_31_GIS_Time_corrected analysis/datasets/Results_Pre_Post/Landuse/Pre/",Landuses[k]))
  ...
  write.csv(resultsAnalyLow,paste0("Similarity_Pre",
                                   Landuses[k],".csv"))
}
